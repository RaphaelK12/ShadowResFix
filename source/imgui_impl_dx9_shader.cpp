...
#include "d3dx9.h"
#include "d3dx9.h"
#include "dxsdk/d3dx9shader.h"

LPDIRECT3DPIXELSHADER9       ImGuiPS;
LPDIRECT3DVERTEXSHADER9      ImGuiVS;
...
static void ImGui_ImplDX9_SetupRenderState(ImDrawData* draw_data) {
    ...
    //
    //	bd->pd3dDevice->GetRenderState(D3DRS_ZWRITEENABLE,				(DWORD*)&_D3DRS_ZWRITEENABLE				  );
    //	bd->pd3dDevice->GetRenderState(D3DRS_ALPHATESTENABLE,			(DWORD*)&_D3DRS_ALPHATESTENABLE				  );
    //	bd->pd3dDevice->GetRenderState(D3DRS_CULLMODE,					(DWORD*)&_D3DRS_CULLMODE					  );
    //	bd->pd3dDevice->GetRenderState(D3DRS_ZENABLE,					(DWORD*)&_D3DRS_ZENABLE						  );
    //	bd->pd3dDevice->GetRenderState(D3DRS_ALPHABLENDENABLE,			(DWORD*)&_D3DRS_ALPHABLENDENABLE			  );
    //	bd->pd3dDevice->GetRenderState(D3DRS_BLENDOP,					(DWORD*)&_D3DRS_BLENDOP						  );
    //	bd->pd3dDevice->GetRenderState(D3DRS_SRCBLEND,					(DWORD*)&_D3DRS_SRCBLEND					  );
    //	bd->pd3dDevice->GetRenderState(D3DRS_DESTBLEND,					(DWORD*)&_D3DRS_DESTBLEND					  );
    //	bd->pd3dDevice->GetRenderState(D3DRS_SEPARATEALPHABLENDENABLE,	(DWORD*)&_D3DRS_SEPARATEALPHABLENDENABLE	  );
    //	bd->pd3dDevice->GetRenderState(D3DRS_SRCBLENDALPHA,				(DWORD*)&_D3DRS_SRCBLENDALPHA				  );
    //	bd->pd3dDevice->GetRenderState(D3DRS_DESTBLENDALPHA,			(DWORD*)&_D3DRS_DESTBLENDALPHA				  );
    //	bd->pd3dDevice->GetRenderState(D3DRS_SCISSORTESTENABLE,			(DWORD*)&_D3DRS_SCISSORTESTENABLE			  );
    //	v1 = false;
    //}
...
bool ImGui_ImplDX9_CreateDeviceObjects() {
    ...
    if(hr != D3D_OK)
        return false;
    hr = bd->pd3dDevice->CreateVertexShader((DWORD*) vertex_shader_buffer->GetBufferPointer(), &ImGuiVS);
    if(hr != D3D_OK)
        return false;

    bd->pvertexShader = ImGuiVS;
    ...
    if(hr != D3D_OK)
        return false;
    hr = bd->pd3dDevice->CreatePixelShader((DWORD*) pixel_shader_buffer->GetBufferPointer(), &ImGuiPS);
    if(hr != D3D_OK)
        return false;
